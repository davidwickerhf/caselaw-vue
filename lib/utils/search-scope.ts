...
export function buildEffectiveEchrFilters(query: SearchQuery): EchrSearchFilters {
    ...
    return {
        ...
        applicationNumbers: mergeList(query.applicationNumbers, scoped.echr.applicationNumbers ?? []),
        ...
        originatingBody: mergeList(query.originatingBody, scoped.echr.originatingBody),
